...
Loading necessary libraries to read data, manipulate data, and plot data.
...
# Base function to make a request to the balldontlie API
fetch_data <- function(endpoint, query_parameters=list()) {
...
# Specific functions with various query options for the API
...
get_games <- function(start_date=NULL, end_date=NULL, team_ids=NULL, page=1) {
  fetch_data("games", list(start_date=start_date, end_date=end_date, team_ids=team_ids, page=page))
}
```
